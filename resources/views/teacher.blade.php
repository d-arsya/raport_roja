...
@section('container')
    ...
    <h1 class="text-pink-600 text-lg italic">{{ $teacher->nip }} <svg onclick="openPopup()" class="inline" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
    ...
    @if ($room)
        ...
        <div class="bg-pink-600 p-2 text-white font-semibold text-xl text-center mt-5 rounded-t-lg">Daftar Pelajaran</div>
        @if ($courses)
