...
@section('container')
    <div onclick="openPopup()"
        class="w-max text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-3 py-2 me-2 mb-2">
        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="bg-white border-1 border-grey-900 dark:bg-gray-800 dark:border-gray-700">
                    <td class="px-6 py-4">
                        <a class="text-red-600" href="/pelajaran/hapus/{{ $course->id }}"><img class="inline" src="{{ Storage::url('assets/trash.svg') }}" alt=""> </a>{{ $course->name }}
                    </td>
